...
export default function Navbar(props: any) {
  return (
    <>
      <nav className="flex items-center justify-center mt-3 rounded-3xl z-[999] inset-0 w-full max-w-[600px] h-14 gap-8 px-4 mx-auto text-stone-200 fixed bg-black">
